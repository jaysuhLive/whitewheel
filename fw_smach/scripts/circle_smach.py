...
def iterate_target_poses():
    target_poses = [   
        create_pose(0.0995, 0.868, 0, 0, 0, 0.539, 0.843),
        create_pose(1.29, -0.182, 0, 0, 0, -0.020, 0.999),
        create_pose(0.671, -1.2, 0, 0, 0, -0.163, 0.987),
        create_pose(-0.528, -0.18, 0, 0, 0, -0.70, 0.711)
    ]
...
def main():
    ...
    intro_server = IntrospectionServer('test', sm, '/TEST')
    intro_server.start()
