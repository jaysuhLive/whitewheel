...
class Freeway_Safety
{
  public:
	...
	r.sleep();
      } while (cmd_msg.linear.x > 0.0 || odom_msg.twist.twist.linear.x > 0.0);
    }

    void stop_logic(float ttc_time, float frequency, nav_msgs::Odometry odom) {
      if (ttc_activate_) {
